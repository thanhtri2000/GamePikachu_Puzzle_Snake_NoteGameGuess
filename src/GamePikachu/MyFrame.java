...
public class MyFrame extends JFrame implements ActionListener, Runnable {
	...
	private String author = "Nhom6_java";
	...
	private JPanel createControlPanel() {
		...
		Icon icon = new ImageIcon(getClass().getResource("/GamePikachu/icon/pokemon.png"));

		// use panel set Layout BorderLayout to panel control in top
		JPanel panel = new JPanel(new BorderLayout());
		panel.setBorder(new TitledBorder("Status_Nhom6"));
	...
	public void run() {
		while (true) {
			...
			progressTime.setValue((int) ((double) time / maxTime * 200));
		}
	}
